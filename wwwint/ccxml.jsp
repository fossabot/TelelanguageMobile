    ...
    <eventprocessor>
        ...
        <transition event="ConferenceJoin">
            <if cond="typeof(event$.termdigits) != 'undefined'">
                <join id1="event$.id1" id2="event$.id2" voxeo-termdigits="event$.termdigits" duplex="event$.duplex" entertone="'true'" exittone="'false'"/>
            <else/>
                <join id1="event$.id1" id2="event$.id2" duplex="event$.duplex" entertone="'true'" exittone="'false'"/>
            </if>
        </transition>
        ...
        <transition event="connection.alerting">
            ...
            <send targettype="'basichttp'" target="targetAddr" name="event$" namelist="sessionid eventname connectionid connectionLocal connectionRemote connectionFrom connectionTo activeconnections"/>
        </transition>
        ...
        <transition event="dialog.exit">
            ...
            <send targettype="'basichttp'" target="targetAddr" name="event$" namelist="sessionid eventname connectionid conferenceid dialogid validated accesscode language deptcode calltype dialogreason"/>
        </transition>
