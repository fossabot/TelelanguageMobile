 ...
 */
package com.telelanguage.interpreter.client.websockets;
...
public class Websocket {
    ...
    private native void _open(Websocket ws, String s, String url) /*-{
        ...
        $wnd[s].onopen = function() { ws.@com.telelanguage.interpreter.client.websockets.Websocket::onOpen()(); };
        $wnd[s].onclose = function(evt) { ws.@com.telelanguage.interpreter.client.websockets.Websocket::onClose(SLjava/lang/String;Z)(evt.code, evt.reason, evt.wasClean); };
        $wnd[s].onerror = function() { ws.@com.telelanguage.interpreter.client.websockets.Websocket::onError()(); };
        $wnd[s].onmessage = function(msg) { ws.@com.telelanguage.interpreter.client.websockets.Websocket::onMessage(Ljava/lang/String;)(msg.data); }
    }-*/;
