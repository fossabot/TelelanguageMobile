...
public class HealthServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		boolean dbOk = TLVXManager.tlvxClient.checkCommunicationsOk(TLVXManager.getProperties().getProperty("thisApiUrl")) != null;
		...
		out.println("<tr><td>Agents:</td><td>"+MessageWebSocket.emailToSessionId.size()+"</td></tr>");
