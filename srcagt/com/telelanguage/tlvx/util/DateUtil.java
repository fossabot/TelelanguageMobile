...
public class DateUtil
{
    ...
    /**
     * SimpleDateFormat in hakano format.
     */
    public static final SimpleDateFormat HAKANO_DATE_FORMAT = new SimpleDateFormat("yyyy/MM/dd' 'HH:mm:ss.SSS");
    /**
    ...
    static
    {
        ...
        HAKANO_DATE_FORMAT.setTimeZone(TimeZone.getDefault());
    }

    /**
     * get the specified date as a string in hakano date format
     *
     * @param date date to get
     * @return string date in hakano date format.
     * @see DateUtil#HAKANO_DATE_FORMAT
     */
    public static String getDateAsHakanoFormat(Date date)
    {
        if (null == date)
        {
            return null;
        ...
        synchronized (HAKANO_DATE_FORMAT)
        {
            return HAKANO_DATE_FORMAT.format(date);
        }
    }
            ...
            catch (Exception ex2)
            {
                ...
                catch (Exception ex3)
                {
                    try
                    {
                        synchronized (HAKANO_DATE_FORMAT)
                        {
                            date = HAKANO_DATE_FORMAT.parse(str);
                        }
                    }
